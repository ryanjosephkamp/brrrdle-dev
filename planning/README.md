...
7. The active or next phase plan. After Phase 35 auth, Profile, deployment, and Live identity readiness, the next routed planning target is Phase 36 Leaderboard/Stats navigation split plus Active Games safe-name, password-copy, and Settings current-surface cleanup.
...
- `planning/phase-36/`: Phase 36 planning brief and implementation plan for Leaderboard/Stats navigation split, Active Games safe-name cleanup, password-copy polish, and Settings section ordering.
