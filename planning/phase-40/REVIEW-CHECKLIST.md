...
- [ ] Phase 40 visual handoff artifacts remain local-only and ignored.
...
- [ ] Public profile route opens only safe public profile content.
...
- [ ] Clickable public identity appears only where approved public profile IDs exist.
...
- [ ] Public profile private Practice request action is authenticated-only and safe.
...
- [ ] Practice Multiplayer shows private incoming/outgoing requests safely.
...
- [ ] Accepting a private Practice request opens the created game for both participants.
...
- [ ] Private matchmaking remains Practice-only, unranked-only, and authenticated-only.
...
- [ ] Mobile scroll smoothness and Word Explorer tuning from Phase 39 still feel intact.
...
- [ ] Review Phase 40 visual screenshots if the local artifact directory is available.
...
- [ ] Spot-check desktop and mobile layouts for the public profile page and Practice Multiplayer private request panel.
...
- [ ] Phase 39 mobile scroll smoothness, mobile scroll/layout harness, and Word Explorer tuning remain intact.
...
- [ ] Any failed item has a follow-up prompt prepared before Phase 40 Git handoff or additional implementation.
