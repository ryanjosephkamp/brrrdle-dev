...
Phase 51 implemented a bounded account/Profile/player-identity pass while preserving the accepted Phase 50 gameplay baseline.
...
- Simplified Profile copy around one user-facing `Player name` concept.
- Made the public profile name default to the player name when the public field is blank.
...
- Profile, Settings, and account badge render coverage for updated copy and menu actions.
...
- Public profile opt-in visibility remains intact.
