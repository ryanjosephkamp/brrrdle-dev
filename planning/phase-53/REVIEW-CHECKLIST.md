...
**Status:** Review Candidate checklist.
**Date:** 2026-07-09.
...
- [ ] From Home, click `Open Stats` in the progression HUD.
...
- [ ] Review the Stats `Data sources` section.
...
- [ ] Review the Stats Solo and bucket sections.
...
- [ ] Review the Stats progression section.
...
- [ ] Review the Stats multiplayer summary section.
...
- [ ] Review the public site stats section.
...
- [ ] Open a visible public profile from the Leaderboard if a public row is available.
