...
- [ ] Public/signed-out users can discover eligible Practice Live games.
...
- [ ] Public/signed-out focused spectation is read-only.
...
- [ ] Authenticated nonparticipant spectation still works.
...
- [ ] Current Daily Multiplayer games are not public/guest spectator rows.
...
- [ ] Public spectator payloads do not expose sensitive identity or game authority data.
...
- [ ] Stale, hidden, completed, deleted, or unavailable public spectator selections fall back safely.
...
- [ ] Spectator presence/count/list UI is absent by design.
...
- [ ] Phase 38 visual handoff artifacts remain local-only and ignored.
...
- [ ] Any failed item has a follow-up prompt prepared before Phase 38 Git handoff or additional implementation.
