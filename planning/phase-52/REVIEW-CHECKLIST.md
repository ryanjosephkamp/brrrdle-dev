...
**Status:** Review Candidate prepared; waiting for Review Candidate Backup and hosted/manual review.
**Phase:** Phase 52 - Private Practice Matchmaking Expansion.
**Repository:** `brrrdle-dev` only.
**Created:** 2026-07-09.
**Evidence:** `planning/phase-52/CHANGELOG.md`, `planning/phase-52/PLANNING-BRIEF.md`, `planning/phase-52/IMPLEMENTATION-PLAN.md`, `progress/PROGRESS-STEP-507.md`, and `progress/PROGRESS-STEP-508.md`.
...
- [ ] Public profile private request controls are visible only when signed in.
...
- [ ] Default private request remains OG, 5 letters, Hard Mode off, no clock.
...
- [ ] Private Practice GO settings can be requested and accepted.
...
- [ ] Private Practice OG settings can be requested and accepted.
...
- [ ] Incoming and outgoing private request shelves remain clear.
...
- [ ] Existing private Practice lifecycle still works.
...
- [ ] Phase 51 Profile still has one public `Player name` and rejects unsupported names.
- [ ] Signed-in account chip/menu still fits on mobile.
- [ ] Ranked Practice FIFO matchmaking still behaves as accepted.
...
- [ ] Manual review passed and Phase 52 can proceed toward final acceptance closure.
