...
- [x] Waiting Multiplayer lobbies remain valid selected-game states.
...
- [x] Stale or unavailable selected-game history falls back safely.
...
- [x] Browser history does not mutate gameplay.
...
- [x] Browser Forward restores the later app route/view.
...
- [x] Browser Back restores the previous app route/view instead of leaving the app immediately.
...
- [x] Joining or resuming a Multiplayer game lands near the gameplay board/keyboard.
...
- [x] Resuming or selecting a Solo active game lands near the gameplay board/keyboard.
...
- [x] Entering Solo Practice lands near the gameplay board/keyboard.
...
- [x] Multiplayer invalid-guess sound behavior still works.
...
- [x] Solo GO invalid guesses use the invalid-guess sound.
...
- [x] Solo OG invalid guesses use the invalid-guess sound.
...
- [x] Phase 37 visual handoff artifacts remain local-only and ignored.
...
- [x] Try typing in a game after auto-centering.
  - Expected: ordinary typing, deleting, timer ticks, and passive remote updates do not keep yanking the page position.
- [x] Try auto-centering with reduced-motion enabled in the operating system/browser.
  - Expected: auto-centering uses non-smooth behavior and remains usable.

- [x] Try browser Back/Forward across Solo, Multiplayer, Leaderboard, Profile, and Settings.
  - Expected: route and subtab state restores cleanly without layout overlap or stale selected-game confusion.

- [x] Review Phase 37 visual screenshots if the local artifact directory is available.
...
- [x] Daily Multiplayer remains claim-safe, answer-separated, no-clock, UTC-day keyed, and five-letter only.
