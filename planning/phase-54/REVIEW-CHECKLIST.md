...
**Status:** Ready for hosted/manual review.
...
- [ ] An authenticated participant can open an eligible opponent public profile from Active Games.
...
- [ ] An authenticated participant can open an eligible opponent public profile from Live and return to the same Multiplayer context.
...
- [ ] No eligible target remains a safe static fallback.
...
- [ ] Lobby host identity stays display-only and core lobby actions still work.
...
- [ ] Authenticated and signed-out spectators remain read-only and cannot open player profiles.
...
- [ ] Focused spectator routing remains intact.
...
- [ ] Mobile participant identity action fits without horizontal clipping.
...
- [ ] Leaderboard-origin profile return remains unchanged.
...
- [ ] Phase 50 Solo persistence and Home-on-refresh behavior remain as accepted.
- [ ] Phase 51 single public Player name, profile chip/menu fit, and mobile scrolling remain as accepted.
- [ ] Phase 52 private Practice requests and Phase 53 Stats/Leaderboard/public-profile metadata remain functional.
- [ ] Daily Multiplayer remains excluded from public/guest Live spectation.
...
- [ ] Manual review passed and Phase 54 can proceed toward final acceptance closure.
- [ ] Manual review found one or more direct Phase 54 issues and Phase 54 should remain open for a same-phase follow-up prompt.
- [ ] Review Candidate backup completed before this manual review.
