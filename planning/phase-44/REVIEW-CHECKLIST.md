...
- [ ] Account and guest progress stay separated.
...
- [ ] Guest progress does not silently overwrite or upload into a signed-in account.
...
- [ ] Private Practice requests work for active public profiles without requiring Elo.
...
- [ ] Ranked Practice fairness behavior remains intact.
...
- [ ] Sign-in modal defaults to Email + password first.
...
- [ ] Global header mode/stat chips are removed from ordinary pages.
...
- [ ] Stats public-site snapshot placement is clearer.
...
- [ ] Help is intentionally a placeholder.
...
- [ ] Solo gameplay keyboard centering is improved after a valid guess.
...
- [ ] Live spectator and public/guest spectator boundaries remain read-only.
...
- [ ] Any failed item has a follow-up prompt prepared before Phase 45 planning or additional implementation.
